...
// 
// "SkyScraper.Tests/When_website_contains_an_explicit_anchor_link.cs" was last cleaned by Rick on 2014/07/06 at 4:00 PM
#endregion
    ...
    internal class When_website_contains_an_explicit_anchor_link : ConcernForScraper {
        ...
        protected override void Context() {
            ...
            this.HttpClient.GetString( Arg.Is< Uri >( x => x != this.Uri ) )
                .Returns( Task.Factory.StartNew( () => { throw new HttpRequestException(); } ) );
        ...
        public void Then_link_should_not_be_scraped() {
            this.HttpClient.DidNotReceive()
                .GetString( Arg.Is< Uri >( x => x.ToString() == "http://test/#here" ) );
        }
