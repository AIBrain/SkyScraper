...
// 
// "SkyScraper.Tests/When_website_has_three_pages.cs" was last cleaned by Rick on 2014/07/06 at 4:00 PM
#endregion
...
namespace SkyScraper.Tests.ScraperFixtures {
    ...
    [TestFixture]
    internal class When_website_has_three_pages : ConcernForScraper {
        ...
        public void Then_htmldocs_should_second_page() {
            this.htmlDocs.Should()
                .Contain( x => x.Uri.ToString() == "http://test/page2" && x.Html == "/page2" );
        }
