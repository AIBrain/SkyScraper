...
// 
// "SkyScraper.Tests/When_website_contains_an_unscrapable_link.cs" was last cleaned by Rick on 2014/07/06 at 4:00 PM
#endregion
...
namespace SkyScraper.Tests.ScraperFixtures {
    ...
    [TestFixture]
    internal class When_website_contains_an_unscrapable_link : ConcernForScraper {
        ...
        public void Then_link_should_not_be_scraped() {
            this.HttpClient.DidNotReceive()
                .GetString( Arg.Is< Uri >( x => x.ToString() == "file://foo" ) );
        }
