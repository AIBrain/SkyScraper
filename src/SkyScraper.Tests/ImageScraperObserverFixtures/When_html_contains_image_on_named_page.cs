...
// 
// "SkyScraper.Tests/When_html_contains_image_on_named_page.cs" was last cleaned by Rick on 2014/07/06 at 4:00 PM
#endregion
...
namespace SkyScraper.Tests.ImageScraperObserverFixtures {
    ...
    [TestFixture]
    internal class When_html_contains_image_on_named_page : ConcernForImageScraperObserverOnNext {
        protected override void Context() {
            base.Context();
            this.HtmlDoc.Html = @"<html>
                         <img src=""image.png"" />
                         </html>";
            this.HtmlDoc.Uri = new Uri( "http://test/index.html" );
