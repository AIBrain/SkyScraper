...
// 
// "SkyScraper.Tests/When_html_contains_a_local_image_in_an_explicit_subdirectory.cs" was last cleaned by Rick on 2014/07/06 at 4:00 PM
#endregion
...
namespace SkyScraper.Tests.ImageScraperObserverFixtures {
    ...
    [TestFixture]
    internal class When_html_contains_a_local_image_in_an_explicit_subdirectory : ConcernForImageScraperObserverOnNext {
        protected override void Context() {
            base.Context();
            this.HtmlDoc.Html = @"<html>
                         <img src=""http://test/images/image.png"" />
                         </html>";
        ...
        public void Then_http_client_should_download_image() {
            this.HttpClient.Received()
                .GetByteArray( Arg.Is< Uri >( x => x.ToString() == "http://test/images/image.png" ) );
        }
    }
}
